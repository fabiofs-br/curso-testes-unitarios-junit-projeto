...
class CalculadoraGanhosTest {
    ...
    void beforeEach() {
        ...
        post = new Post(1L, "Ecossistema Java", "O ecossistema do Java, é muito maduro", autor,
                "ecossitema-java-abc123", null, false, false);
    }

    @Test
    public void Dado_um_post_e_autor_premium_Quando_calcular_gahnos_Entao_deve_retornar_valor_com_bonus() {
    ...
    @Test
    public void Dado_um_post_e_eautor_nao_premium_Quando_caalcular_ganhos_Entao_deve_retornar_valor_sem_bonus() {
